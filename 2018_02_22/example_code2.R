## Code from the repo - https://github.com/philippmuench/AIH_metagenome/blob/master/src/alpha.diversity.functions.R
## Main contributors are 
# Philipp C. Münch - https://github.com/philippmuench

# Postgraduate in Bioinformatics of infection research at Helmholtz University 
